              ...
              <div className="all">
                <div className="slider">
                  <div className="owl-carousel owl-theme main">
                    <div
                      // style="background-image: url(/img/products/shoes/1.jpg);"
                      className="item-box"
                    ></div>
                    <div
                      // style="background-image: url(/img/products/shoes/2.jpg);"
                      className="item-box"
                    ></div>
                    <div
                      // style="background-image: url(/img/products/shoes/3.jpg);"
                      className="item-box"
                    ></div>
                    <div
                      // style="background-image: url(/img/products/shoes/4.jpg);"
                      className="item-box"
                    ></div>
                    <div
                      // style="background-image: url(/img/products/shoes/5.jpg);"
                      className="item-box"
                    ></div>
                    <div
                      // style="background-image: url(/img/products/shoes/6.jpg);"
                      className="item-box"
                    ></div>
                  </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-5 btn_panel">
                <a href="cart.js" className="btn_1 outline">
                  View cart
                </a>{' '}
                <a href="checkout.js" className="btn_1">
                  Checkout
                </a>
              </div>
            </div>
